import { ModularSimulator, logger } from "./simulators/simulator.js";
...
function createSimulator() {
  const simulator = ModularSimulator.deployContract(key1);
...
describe("Counter smart contract", () => {
  it("Display intial values", () => {
    ...
    expect(initialLedgerState.Counter__round).toEqual(0n);
  ...
  it("increments the counter correctly", () => {
    ...
    expect(nextLedgerState.Counter__round).toEqual(1n);
